    ...
    <div className='text-white relative'>
      ...
      <div className="lg:pt-40 pt-20 lg:pb-24 pb-12 relative z-0">
        ...
        <div className="flex items-center justify-center gap-4 md:my-10 my-5">
          <button className="md:size-12 size-10 rounded-full border border-white flex items-center justify-center not-disabled:cursor-pointer not-disabled:hover:bg-grayscale-500" ref={prevRef}>
            <ArrowLeftSmall size={28} />
          </button>
          <button className="md:size-12 size-10 rounded-full border border-white flex items-center justify-center not-disabled:cursor-pointer not-disabled:hover:bg-grayscale-500" ref={nextRef}>
