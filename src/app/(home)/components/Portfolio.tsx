...
const Portfolio = () => {
  ...
  return (
    <div className='lg:mb-16 mb-8 relative'>
      ...
      <button className="absolute lg:left-20 left-4 top-1/2 -translate-y-1/2 md:size-14 size-10 rounded-full border border-grayscale-800 flex items-center justify-center not-disabled:cursor-pointer not-disabled:hover:bg-grayscale-800 not-disabled:hover:text-white z-10 bg-white disabled:border-grayscale-400" ref={prevRef}>
        <ArrowLeftSmall size={28} />
      </button>
      <button className="absolute lg:right-20 right-4 top-1/2 -translate-y-1/2 md:size-14 size-10 rounded-full border border-grayscale-800 flex items-center justify-center not-disabled:cursor-pointer not-disabled:hover:bg-grayscale-800 not-disabled:hover:text-white z-10 bg-white disabled:border-grayscale-400" ref={nextRef}>
